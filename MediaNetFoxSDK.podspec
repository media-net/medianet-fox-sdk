...
Pod::Spec.new do |s|
  ...
  # Exact pins (not floors): 0.4.5 carries the re-signed MNPrebidMobile that
  # fixes the iOS 26 simulator CODESIGNING/Invalid Page crash, and 0.0.23 is the
  # matching renderer. Exact-pinning guarantees consumers resolve this tested
  # combination rather than silently picking a different patch.
  s.dependency 'MediaNetAdSDK', '0.4.5'
